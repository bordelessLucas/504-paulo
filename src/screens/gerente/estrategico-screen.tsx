...
export function EstrategicoScreen() {
  ...
  const handleSelectColaborador = useCallback(async (colaborador: ColaboradorAtivo) => {
  ...
  }, [justificativa, selected, showToast, user]);

  const canSubmit = justificativa.trim().length >= 10 && !isSubmitting && !isLoadingMedia;
      ...
      <SafeAreaView style={styles.safeArea} edges={['bottom']}>
        <ScrollView
          ...
          <View style={styles.header}>
            <ThemedText type="heading">Painel estratégico</ThemedText>
            <ThemedText themeColor="textSecondary" style={styles.description}>
              Solicite melhoria salarial ou curso para um colaborador. A solicitação segue para
              validação do RH e aprovação do CEO.
            </ThemedText>
          </View>
          ...
          <View
            ...
            <ThemedText themeColor="textSecondary" style={styles.hint}>
              Toque em um colaborador ativo para ver a média histórica e preencher a justificativa.
            </ThemedText>
            ...
            <View
              ...
              <View style={styles.field}>
                <ThemedText themeColor="textSecondary" style={styles.fieldLabel}>
                  Justificativa para Melhoria/Curso
                </ThemedText>
                <TextInput
                  multiline
